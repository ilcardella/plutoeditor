...
import plutoeditor.figure.PriorityManagerFigure;

public class PriorityManagerEditPart extends AppAbstractEditPart implements NodeEditPart {

	@Override
	protected IFigure createFigure() {
		IFigure figure = new PriorityManagerFigure();
		return figure;
	}
	...
	protected void refreshVisuals() {
		PriorityManagerFigure figure = (PriorityManagerFigure) getFigure();
	...
	public List<Connection> getModelSourceConnections() {
        return ((PriorityManager)getModel()).getSourceConnections();
    }
    
    public List<Connection> getModelTargetConnections() {
        return ((PriorityManager)getModel()).getTargetConnections();
    }
