...
import plutoeditor.figure.DroneAllocatorFigure;

public class DroneAllocatorEditPart extends AppAbstractEditPart implements NodeEditPart {

	@Override
	protected IFigure createFigure() {
		IFigure figure = new DroneAllocatorFigure();
		return figure;
	}
	...
	protected void refreshVisuals() {
		DroneAllocatorFigure figure = (DroneAllocatorFigure) getFigure();
		DroneAllocator model = (DroneAllocator) getModel();
	...
	public List<Connection> getModelSourceConnections() {
        return ((DroneAllocator)getModel()).getSourceConnections();
    }
    
    public List<Connection> getModelTargetConnections() {
        return ((DroneAllocator)getModel()).getTargetConnections();
    }
