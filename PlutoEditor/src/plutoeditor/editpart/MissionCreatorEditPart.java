...
import plutoeditor.figure.MissionCreatorFigure;

public class MissionCreatorEditPart extends AppAbstractEditPart implements NodeEditPart{

	@Override
	protected IFigure createFigure() {
		IFigure figure = new MissionCreatorFigure();
		return figure;
	}
	...
	protected void refreshVisuals() {
		MissionCreatorFigure figure = (MissionCreatorFigure) getFigure();
		MissionCreator model = (MissionCreator) getModel();
	...
	public List<Connection> getModelSourceConnections() {
		return ((MissionCreator) getModel()).getSourceConnections();
	}

	public List<Connection> getModelTargetConnections() {
		return ((MissionCreator) getModel()).getTargetConnections();
	}
