...
import plutoeditor.figure.TripMonitorFigure;

public class TripMonitorEditPart extends AppAbstractEditPart implements NodeEditPart {

	@Override
	protected IFigure createFigure() {
		IFigure figure = new TripMonitorFigure();
		return figure;
	}
	...
	protected void refreshVisuals() {
		TripMonitorFigure figure = (TripMonitorFigure) getFigure();
		TripMonitor model = (TripMonitor) getModel();
	...
	public List<Connection> getModelSourceConnections() {
        return ((TripMonitor)getModel()).getSourceConnections();
    }
    
    public List<Connection> getModelTargetConnections() {
        return ((TripMonitor)getModel()).getTargetConnections();
    }
