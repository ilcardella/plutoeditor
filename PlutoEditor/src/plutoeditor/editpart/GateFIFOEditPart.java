...
import plutoeditor.figure.GateFIFOFigure;
import plutoeditor.model.editor.GateFIFO;
import plutoeditor.model.editor.Connection;
import plutoeditor.model.editor.Node;

public class GateFIFOEditPart extends AppAbstractEditPart implements
		NodeEditPart {

	@Override
	protected IFigure createFigure() {
		IFigure figure = new GateFIFOFigure();
		return figure;
	}
	...
	protected void refreshVisuals() {
		GateFIFOFigure figure = (GateFIFOFigure) getFigure();
		GateFIFO model = (GateFIFO) getModel();
	...
	public List<Connection> getModelSourceConnections() {
		return ((GateFIFO) getModel()).getSourceConnections();
	}

	public List<Connection> getModelTargetConnections() {
		return ((GateFIFO) getModel()).getTargetConnections();
	}
