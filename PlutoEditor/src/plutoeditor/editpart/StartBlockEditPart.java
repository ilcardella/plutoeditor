...
import plutoeditor.figure.StartBlockFigure;
import plutoeditor.model.editor.StartBlock;
import plutoeditor.model.editor.Connection;
import plutoeditor.model.editor.Node;

public class StartBlockEditPart extends AppAbstractEditPart implements NodeEditPart {

	@Override
	protected IFigure createFigure() {
		IFigure figure = new StartBlockFigure();
		return figure;
	}
	...
	protected void refreshVisuals() {
		StartBlockFigure figure = (StartBlockFigure) getFigure();
	...
	public List<Connection> getModelSourceConnections() {
		return ((StartBlock) getModel()).getSourceConnections();
	}

	public List<Connection> getModelTargetConnections() {
		return ((StartBlock) getModel()).getTargetConnections();
	}
