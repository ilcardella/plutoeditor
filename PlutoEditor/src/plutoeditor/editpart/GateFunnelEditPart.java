...
import plutoeditor.figure.GateFunnelFigure;
import plutoeditor.model.editor.Connection;
import plutoeditor.model.editor.GateFunnel;
import plutoeditor.model.editor.Node;

public class GateFunnelEditPart extends AppAbstractEditPart implements NodeEditPart {
	@Override
	protected IFigure createFigure() {
		IFigure figure = new GateFunnelFigure();
		return figure;
	}
	...
	protected void refreshVisuals() {
		GateFunnelFigure figure = (GateFunnelFigure) getFigure();
		GateFunnel model = (GateFunnel) getModel();
	...
	public List<Connection> getModelSourceConnections() {
		return ((GateFunnel) getModel()).getSourceConnections();
	}

	public List<Connection> getModelTargetConnections() {
		return ((GateFunnel) getModel()).getTargetConnections();
	}
